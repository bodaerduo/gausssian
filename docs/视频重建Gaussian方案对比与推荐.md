...
- 当前 API 的质量档位：快速/推荐/高质量分别为 1280×720 / 1280×720 / 1920×1080 输入、3/4/6 FPS、12k/30k/50k Brush iterations；Brush 最大训练分辨率为 720/720/1080，最大 Splat 数量为 2.5M/5M/8M。创建任务时可用表单参数手动覆盖默认值。
